...
const AdminEvent = ({ image1, image2, image3, image4, eventName, description, tags }) => {
    ...
    return (
        <div>
            ...
            <div className='h-screen w-screen bg-blue-300 text-center flex items-center justify-center'>EDIT STUFF</div>
        </div>
    )
}
