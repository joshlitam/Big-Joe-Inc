...
const AdminEventDescription = ({ eventName, eventDescription, tags }) => {
    return (
        <div className="et-text flex flex-col justify-center items-start gap-8 mx-16 flex-1">
            ...
            <Link href="/admin"><button className='px-6 py-4 bg-green-500 rounded-lg text-white'>Back to Admin Dashboard</button></Link>
        </div>
    )
}
