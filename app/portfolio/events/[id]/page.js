...
const page = () => {
    ...
    return (
        <Event image1={event.primaryImage} image2={event.supportingImage[0]} image3={event.supportingImage[1]} image4={event.supportingImage[2]} eventName={event.eventName} description={event.description} tags={event.tags} />
